...
def wit_ai():
	...
	if 'error' not in response.keys():
                ...
                # See if our code handles the specified command
                #WIT.AI IS NEEDED FOR THIS TO WORK!
		#TO ADD ANOTHER CKMMAND COPY THIS AND CHANGE IF TO elif. THE REST IS COMMEN SENSE. FYI: INDENTATIONS MATTER
                if response["_text"] == "who created you":
                        offline_speak("Alexa was created by Amazon, I was created by Franklin, but WeCreate fixed me.")
